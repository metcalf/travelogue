...
describe User do
  ...
  describe "basic attributes" do
    ...
    it "should accept a profile" do
      @user.profile = "blah blah blah"
    end

    it "should associate with a personal photo" do
      @user.photo = m_photo
    end

    it "should associate with trips" do
      @user.trips << m_trip
    end
    ...
    it "should generate a secret" do
      @user.save
      @user.valid_secret?(@user.secret).should be_true
    end

    it "should not accept an old secret" 
  end
